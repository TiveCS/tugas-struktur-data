...
public:
    ...
    // Mendapatkan pointer nilai infotype
    T* getInfoPtr(){
        return info;
    }

    // Mendapatkan reference nilai infotype
    T& getInfoRef(){
        return &info;
    }
...
public:
    ...
    void removeElement(ListNode<T> *e){
        ...
        }else if (hasElement(e)){ // Jika node berada ditengah (delete after)
